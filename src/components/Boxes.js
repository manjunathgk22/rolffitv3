...
function Boxes() {
  return (
    <div className="container m-auto boxes-container">
      <div className="px-4 py-3 text-4xl max-w-5xl mx-auto lg:text-6xl mb-0 font-bold text-center">we help you build a hands-on approach to lifting the spirits and goodwill of your employees</div>
