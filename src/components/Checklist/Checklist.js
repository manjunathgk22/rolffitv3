...
function Checklist() {
  return (
    <ul data-v-ed816bee="" class="CheckList">
      <li data-v-ed816bee="" class="CheckList__wrapper">
        <div data-v-ed816bee="" class="CheckList__item">
          <div data-v-ed816bee="" class="CheckList__item__number">
            1
          </div>
          <span data-v-ed816bee="" class="text-2xl md:text-2xl lg:text-2xl font-extrabold leading-4 mb-2 block">
            get a free demo
          </span>
